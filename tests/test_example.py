...
def test_subst_numbers() -> None:
    """Проверяет сложение двух разнозначных чисел (вычитание)."""
    assert add(3, -2) == 1  # assert проверяет: если выражение ложно, тест падает с ошибкой.
